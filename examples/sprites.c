...
int main(int argc, char* argv[]) {
    ...
    for (size_t i = 0; i < (size_t)t.dimensions.y; i++) {
        for (size_t j = 0; j < (size_t)t.dimensions.x; j++) {
    ...
    for (size_t col = 0; col < (size_t)(t.dimensions.x / t.tile_dimensions.x);
         col++) {
        ...
        } else if (col == (size_t)(t.dimensions.x / t.tile_dimensions.x - 1)) {
    ...
    for (size_t row = 1;
         row < (size_t)(t.dimensions.y / t.tile_dimensions.y - 1); row++) {
